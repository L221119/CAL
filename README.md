...
**Training Objective**: To achieve smooth and efficient driving control while satisfying safety constraints.
...
**Automation**: The training script automatically starts the CARLA server, eliminating the need to manually launch the simulator in advance.
